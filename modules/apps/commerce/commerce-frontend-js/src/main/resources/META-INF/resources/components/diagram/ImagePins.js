...
const ImagePins = ({ 
    ...
    let svg, container, position, handleAddPin, handleMoveUp, handleMoveDown, handleMoveLeft, handleMoveRight, handleZoomIn, handleZoomOut;
    ...
    useLayoutEffect(() => {
        ...
        function dragended(event, d) {
            ...
            const newState = cPins.map(element => element.id === newCoords.id ? newCoords : element);
            setCpins(newState)
        }
