...
const start = (ctx, canvas, lastX, lastY, scaleFactor, img) => {
    ...
    canvas.addEventListener('DOMMouseScroll', (event) => handleScroll(ctx, event, lastX, lastY, img), false);
...
const ImageCanvas = (props) => {
    ...
    window.onload = () => {
        ...
        console.log(gkhead)
        redraw(ctx, props.completeimageSettings.width, props.completeimageSettings.height, gkhead)
        ...
        canvas.addEventListener('mouseup', (event) => {
            ...
            if (!dragged) {
                zoom(ctx, cli, lastX, lastY, props.completeimageSettings.scaleFactor)
            }
        }, false);
        ...
        canvas.addEventListener('DOMMouseScroll', (event) => handleScroll(ctx, event, lastX, lastY, gkhead), false);
        canvas.addEventListener('mousewheel', (event) => handleScroll(ctx, event, lastX, lastY, gkhead), false);
