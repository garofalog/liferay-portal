...
import AddToCart from '../../src/main/resources/META-INF/resources/components/add_to_cart/AddToCartWrapper';
import {
    accountTemplate,
    getAccounts,
...
const DELIVERY_HEADLESS_API_ENDPOINT = ServiceProvider.DeliveryCartAPI('v1').baseURL;


describe('AddToCart', () => {
    beforeEach(() => {
        const accountsEndpointRegexp = new RegExp(
            DELIVERY_HEADLESS_API_ENDPOINT
        );
        const ordersEndpointRegexp = new RegExp(DELIVERY_HEADLESS_API_ENDPOINT);
