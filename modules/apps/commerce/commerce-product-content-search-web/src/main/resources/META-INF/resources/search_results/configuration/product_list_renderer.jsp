...
<aui:fieldset markupView="lexicon">
	<aui:select id='<%= liferayPortletResponse.getNamespace() + "chooseCPContentListRendererKey" %>' label="product-list-renderer" name="preferences--cpContentListRendererKey--">
