...
create unique index IX_EA56CEC4 on CIWarehouse (companyId, name[$COLUMN_LENGTH:75$]);
...
create index IX_47C7DBEB on CommerceInventoryWarehouseRel (CIWarehouseId);
create index IX_13812537 on CommerceInventoryWarehouseRel (classNameId, CIWarehouseId);
create unique index IX_1F7C70B6 on CommerceInventoryWarehouseRel (classNameId, classPK, CIWarehouseId);