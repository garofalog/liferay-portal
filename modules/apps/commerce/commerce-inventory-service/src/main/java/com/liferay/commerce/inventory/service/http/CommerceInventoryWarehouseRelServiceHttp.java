...
public class CommerceInventoryWarehouseRelServiceHttp {
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommerceInventoryWarehouseRelServiceUtil.class,
				"getCommerceOrderTypeCommerceInventoryWarehouseRels",
				_getCommerceOrderTypeCommerceInventoryWarehouseRelsParameterTypes5);
	...
	public static int getCommerceOrderTypeCommerceInventoryWarehouseRelsCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCommerceOrderTypeCommerceInventoryWarehouseRelsCountParameterTypes6);
	...
	public static
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommerceInventoryWarehouseRelServiceUtil.class,
				"getCommerceInventoryWarehouseRel",
				_getCommerceInventoryWarehouseRelParameterTypes7);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommerceInventoryWarehouseRelServiceUtil.class,
				"getCommerceInventoryWarehouseRels",
				_getCommerceInventoryWarehouseRelsParameterTypes8);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				CommerceInventoryWarehouseRelServiceUtil.class,
				"getCommerceInventoryWarehouseRels",
				_getCommerceInventoryWarehouseRelsParameterTypes9);
	...
	public static int getCommerceInventoryWarehouseRelsCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getCommerceInventoryWarehouseRelsCountParameterTypes10);
	...
	private static final Class<?>[]
		_getCommerceInventoryWarehouseRelParameterTypes7 = new Class[] {
			long.class
		};
	private static final Class<?>[]
		_getCommerceInventoryWarehouseRelsParameterTypes8 = new Class[] {
			long.class
		};
	private static final Class<?>[]
		_getCommerceInventoryWarehouseRelsParameterTypes9 = new Class[] {
			long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[]
		_getCommerceInventoryWarehouseRelsCountParameterTypes10 = new Class[] {
			long.class
		};
