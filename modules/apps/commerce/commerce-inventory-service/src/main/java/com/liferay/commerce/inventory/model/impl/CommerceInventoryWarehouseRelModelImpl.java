...
/**
 * The base model implementation for the CommerceInventoryWarehouseRel service. Represents a row in the &quot;CommerceInventoryWarehouseRel&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class CommerceInventoryWarehouseRelModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "CommerceInventoryWarehouseRel";
	...
	public static final String TABLE_SQL_CREATE =
		"create table CommerceInventoryWarehouseRel (mvccVersion LONG default 0 not null,CIWarehouseRelId LONG not null primary key,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,classNameId LONG,classPK LONG,CIWarehouseId LONG)";

	public static final String TABLE_SQL_DROP =
		"drop table CommerceInventoryWarehouseRel";
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(
		com.liferay.commerce.inventory.service.util.ServiceProps.get(
			"lock.expiration.time.com.liferay.commerce.inventory.model.CommerceInventoryWarehouseRel"));
	...
	private static Function<InvocationHandler, CommerceInventoryWarehouseRel>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			CommerceInventoryWarehouseRel.class.getClassLoader(),
			CommerceInventoryWarehouseRel.class, ModelWrapper.class);

		try {
			Constructor<CommerceInventoryWarehouseRel> constructor =
				(Constructor<CommerceInventoryWarehouseRel>)
