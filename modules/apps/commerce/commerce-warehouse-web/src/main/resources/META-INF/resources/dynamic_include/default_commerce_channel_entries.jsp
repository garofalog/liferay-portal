		...
		<div class="form-group-item">
			...
			<div class="btn-group button-holder">
				...
				<c:if test="<%= commerceAccountEntryDisplay.getDefaultPaymentCommerceTermEntry() != null %>">
					<portlet:actionURL name="/commerce_channels/edit_account_entry_default_commerce_channels" var="removeDefaultPaymentCommerceTermEntryURL">
		...
		<div class="form-group-item">
			...
			<div class="btn-group button-holder">
				...
				<c:if test="<%= commerceAccountEntryDisplay.getDefaultDeliveryCommerceTermEntry() != null %>">
					<portlet:actionURL name="/commerce_channels/edit_account_entry_default_commerce_channels" var="removeDefaultDeliveryCommerceTermEntryURL">
						<portlet:param name="redirect" value="<%= currentURL %>" />
						<portlet:param name="accountEntryId" value="<%= String.valueOf(commerceAccountEntryDisplay.getAccountEntryId()) %>" />
						<portlet:param name="commerceTermEntryId" value="0" />
...
<portlet:renderURL var="selectDefaultCommerceTermEntryURL" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
	<portlet:param name="mvcRenderCommandName" value="/commerce_channels/edit_account_entry_default_commerce_channels" />
	<portlet:param name="redirect" value="<%= currentURL %>" />
	<portlet:param name="accountEntryId" value="<%= String.valueOf(commerceAccountEntryDisplay.getAccountEntryId()) %>" />
</portlet:renderURL>

<portlet:actionURL name="/commerce_channels/edit_account_entry_default_commerce_channels" var="updateAccountEntryDefaultCommerceTermEntryURL">
	<portlet:param name="redirect" value="<%= currentURL %>" />
	<portlet:param name="accountEntryId" value="<%= String.valueOf(commerceAccountEntryDisplay.getAccountEntryId()) %>" />
</portlet:actionURL>
