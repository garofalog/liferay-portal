...
<liferay-portlet:renderURL var="editCommerceTermEntryExternalReferenceCodeURL" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
	<portlet:param name="mvcRenderCommandName" value="/commerce_channels/edit_commerce_channels_external_reference_code" />
...
<liferay-frontend:screen-navigation
	...
	key="<%= CommerceTermEntryScreenNavigationEntryConstants.SCREEN_NAVIGATION_KEY_commerce_channels_GENERAL %>"
