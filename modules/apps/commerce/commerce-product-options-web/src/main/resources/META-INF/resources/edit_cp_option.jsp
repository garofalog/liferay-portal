...
<<<<<<< HEAD:modules/apps/commerce/commerce-product-options-web/src/main/resources/META-INF/resources/edit_cp_option.jsp
<portlet:actionURL name="/cp_options/edit_cp_option" var="editProductOptionActionURL" />
=======
PortletURL portletURL = renderResponse.createRenderURL();
%>
>>>>>>> COMMERCE-5362 commerce-product-options-web added and managed headless dataset to CPOption jsp files:modules/apps/commerce/commerce-product-options-web/src/main/resources/META-INF/resources/edit_option.jsp
