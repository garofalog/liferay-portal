...
export default function ({cmd, editCPSpecificationOptionActionURL, namespace}) {
	const deleteCPOptionCategoriesLink = document.getElementById(
		`${namespace}deleteCPSpecificationOptions`
	);
	...
	deleteCPOptionCategoriesLink.addEventListener('click', (event) => {
		...
		if (
			...
			const deleteForm = document.querySelector(
				`input[type=hidden][name="deleteCPSpecificationOptionIds"]`
			);
			...
			submitForm(form, editCPSpecificationOptionActionURL);
		}
	});
}
