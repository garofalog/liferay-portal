...
public class Mutation {
	...
	@GraphQLField
	public Response deleteWarehouseId(@GraphQLName("id") Long id)
		throws Exception {
	...
	public WarehouseOrderType
			createWarehousByExternalReferenceCodeWarehouseOrderType(
				@GraphQLName("externalReferenceCode") String
					externalReferenceCode,
		...
		return _applyComponentServiceObjects(
			...
			warehouseOrderTypeResource ->
				warehouseOrderTypeResource.
					postWarehousByExternalReferenceCodeWarehouseOrderType(
						externalReferenceCode, warehouseOrderType));
	}

	@GraphQLField
	public WarehouseOrderType createWarehousIdWarehouseOrderType(
			@GraphQLName("id") Long id,
			@GraphQLName("warehouseOrderType") WarehouseOrderType
				warehouseOrderType)
		throws Exception {
		...
		return _applyComponentServiceObjects(
			...
			this::_populateResourceContext,
			warehouseOrderTypeResource ->
				warehouseOrderTypeResource.postWarehousIdWarehouseOrderType(
